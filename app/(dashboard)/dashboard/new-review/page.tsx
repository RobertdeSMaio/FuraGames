...
export default function NewReviewPage() {
  ...
  return (
    <div className="p-8 max-w-3xl mx-auto">
      ...
      <h1 className="text-3xl font-bold text-zinc-100 mb-2">Nova Análise</h1>
      <p className="text-zinc-400 mb-8">
        Adicione uma nova análise de jogo à sua coleção
      </p>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            className="flex-1 py-3 rounded-lg bg-yellow-500 text-zinc-950 font-semibold hover:bg-orange-400 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
