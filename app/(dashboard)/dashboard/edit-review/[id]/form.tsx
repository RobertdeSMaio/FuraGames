...
export default function EditReviewForm({ review }: { review: GameReview }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.refresh(); // Garante que os dados novos apareçam no dashboard
    } catch (err) {
          ...
          <div className="bg-zinc-900 rounded-2xl border border-zinc-800 p-6 space-y-6">
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                required
                rows={4}
                className="w-full px-4 py-3 rounded-lg bg-zinc-800 border border-zinc-700 text-zinc-100 focus:outline-none focus:ring-2 focus:ring-yellow-500 resize-none"
              />
            </div>
          </div>
                ...
                {formData.pros.map((pro, index) => (
                  <div key={index} className="flex items-center gap-2">
                    <input
                      ...
                      className="flex-1 px-4 py-2 rounded-lg bg-zinc-800 border border-zinc-700 text-zinc-100 focus:outline-none focus:ring-2 focus:ring-yellow-500"
                    />
