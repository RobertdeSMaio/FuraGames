...
import { Gamepad2, LayoutDashboard, LogOut, Plus, Users } from "lucide-react";
      ...
      <aside className="w-64 bg-zinc-900 border-r border-zinc-800 flex flex-col fixed h-full">
        ...
        <nav className="flex-1 p-4 space-y-2">
          ...
          <Link
            ...
            className="flex items-center gap-3 px-4 py-3 rounded-lg bg-violet-500/20 text-violet-400 hover:bg-violet-500/30 transition-colors mt-4"
          >
